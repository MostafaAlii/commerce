    ...
    <div class="paths py-4">
        <div class="container">
            <p style="gap: 0.5rem" class="d-flex align-items-center">
                ...
                <span>{{trans('site/home.products')}}</span>
                <i class="fa-solid fa-chevron-left"></i>
                    ...
                    <div class="product-imgs">
                        ...
                        <div class="img-select">
                            @foreach ($product as $productData)
                                <div class="img-item">
                                    <a href="#" data-id="1">
                                        <img src="{{-- $productData->GallaryPath() --}}" alt="{{-- $productData?->name --}}" />
                                    </a>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-content">
                        ...
                        <div class="product-detail">
                            <h2>{{ trans('site/home.description') }} :</h2>
                            <p>
                                {{ $product->description }}
                            </p>
                        ...
                        <div class="price d-flex align-items-center gap-3">
                            @if ($product->cost_discount)
                                {{ $product->cost_discount }} {{ trans('site/home.sar') }}
                                <del class="text-secondary">{{ $product->cost }} {{ trans('site/home.sar') }}</del>
                            @else
                                {{ $product->price }} {{ trans('site/home.sar') }}
                            @endif
                        </div>
                        <div class="purchase-info d-flex flex-column flex-md-row gap-2 pb-3 border-bottom">
                            <div class="input-group d-flex align-items-center gap-2">
                                <span class="minus">
                                    <i class="fa-solid fa-minus"></i>
                                </span>
                                <input type="number" class="quantity__input count" min="0" value="1" />
                                <span class="plus">
                            ...
                            <div class="btn shop-btn">
                                <a data-id="{{ $product->id }}" data-message ="{{ trans('site/home.login_first') }}"
                                    onclick="addCart(this)">{{ trans('site/home.add_to_cart') }} <i
                                        class="fas fa-shopping-cart"></i></a>

                            </div>
                            <div class="btn shop-btn">
                                <a data-id="{{ $product->id }}" data-message ="{{ trans('site/home.login_first') }}"
                                    onclick="buynow(this)">{{ trans('site/home.buy_now') }} <i class="fas fa-shopping-cart"></i></a>

                            </div>
                        </div>
                        <div class="product-info">
                            <ul class="d-flex flex-column flex-md-row justify-content-around">
                                <li class="text-secondary"><span>Sku : </span> {{ $product->quantity }}</li>
                                {{-- <li class="text-secondary"><span>Brand:</span> Chanel</li> --}}
                                <li class="text-secondary">
                                    <span>{{ trans('site/home.category') }} : </span>
                                    <a href="{{route('site.category.products', $product->category->id)}}"> {{ $product->category->name }} </a>
                                </li>
                            </ul>
                        </div>
                        <div class="payment-method border p-3">
                            <h6 class="mb-3 fw-normal">{{ trans('site/home.guaranted_safe_Checkout') }}</h6>
                            <ul class="d-flex align-items-center justify-content-around">
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img1.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img2.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img3.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img4.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img5.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img6.svg') }}" alt=""
                                        class="mw-100" />
                                </li>
                                {{-- <li>
                                    <img src="{{ asset('assets/web/asset_en/img/payment-img7.svg') }}" alt="" class="mw-100" />
                                </li> --}}
                            </ul>
                        </div>
                        <div class="shipping d-flex flex-column gap-2 mt-3">
                            <div class="shipp d-flex align-items-center gap-2">
                                ...
                                <p class="text-secondary">
                                    {{ trans('site/home.free_worldwide_shipping_on_all_orders_over') }}
                                </p>
                            </div>
                            <div class="shipp d-flex align-items-center gap-2">
                                ...
                                <p class="text-secondary">
                                    {{ trans('site/home.delivers_in_working_days_shipping_return') }}
                                </p>
                            </div>
                        </div>
                        <div class="compare-wishlist mt-3 d-flex align-items-center gap-4">
                            <a onclick="addCompare(this)" data-id="{{ $product->id }}" class="text-black">
                                ...
                                <span style="font-size: 14px"><a onclick="addCompare(this)"
                                        data-id="{{ $product->id }}">{{ trans('site/home.compare') }}</a></span>
                            </a>
                            <a onclick="toggleFavoriteProduct(this)" data-id="{{ $product->id }}" class="text-black">
                                ...
                                <span style="font-size: 14px"><a onclick="toggleFavoriteProduct(this)"
                                        data-id="{{ $product->id }}">{{ trans('site/home.add_wishlist') }}</a></span>
                            </a>
                        </div>
                    </div>
                </div>
